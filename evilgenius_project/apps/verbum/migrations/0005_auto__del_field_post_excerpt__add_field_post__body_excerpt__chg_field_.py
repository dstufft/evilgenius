...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('verbum_post', 'excerpt')

        # Adding field 'Post._body_excerpt'
        db.add_column('verbum_post', '_body_excerpt', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Changing field 'Post.body'
        db.alter_column('verbum_post', 'body', self.gf('model_utils.fields.SplitField')(no_excerpt_field=True))


    def backwards(self, orm):
        
        # Adding field 'Post.excerpt'
        db.add_column('verbum_post', 'excerpt', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Post._body_excerpt'
        db.delete_column('verbum_post', '_body_excerpt')

        # Changing field 'Post.body'
        db.alter_column('verbum_post', 'body', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'verbum.post': {
            ...
            '_body_excerpt': ('django.db.models.fields.TextField', [], {}),
            'bloggable_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['verbum.Bloggable']", 'unique': 'True', 'primary_key': 'True'}),
