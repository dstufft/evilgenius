...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bloggable.category'
        db.add_column('verbum_bloggable', 'category', self.gf('django.db.models.fields.CharField')(default='post', max_length=75), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bloggable.category'
        db.delete_column('verbum_bloggable', 'category')
